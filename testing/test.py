...
if __name__ == "__main__":
  ...
  print()
  test("Hard reset container - success",                 "POST", f"{BASE_URL}/{FACILITY_ID}/hardResetApp?name={APP_NAME}",     200)
  test("Hard reset container - invalid facility ID",     "POST", f"{BASE_URL}/iaminvalid/hardResetApp?name={APP_NAME}",        400)
  test("Hard reset container - invalid app name",        "POST", f"{BASE_URL}/{FACILITY_ID}/hardResetApp?name=iaminvalid",     400)
  test("Hard reset container - no app name",             "POST", f"{BASE_URL}/{FACILITY_ID}/hardResetApp",                     400)
  print()
