...
def getAppStats(facility_id, app_name="", app_id="") -> flask.Response:
  """
  ...
  completedProcess = subprocess.run(f"docker stats -a --no-stream --format json", shell=True, capture_output=True)
